...
echo '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"/>' .
    ...
    '/iwbx-assets/css/font-awesome.min.css" rel="stylesheet"/>' . '<link href="' . $set['siteurl'] .
    '/iwbx-assets/css/custom.css" rel="stylesheet"/>' .
...
if ($user->logIn)
{
    echo '<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><strong><i class="fa fa-user"></i> ' .
        ...
        '<li><a href="' . $baseurl .
        '/account"><i class="fa fa-user"></i> Akun</a></li>' . '<li><a href="' . $baseurl .
        '/panel"><i class="fa fa-dashboard"></i> Panel</a></li>' .
        '<li class="divider"></li><li><a href="' . $baseurl .
        '/site/logout"><i class="fa fa-sign-out"></i> Keluar</a></li></ul></li>';
}
else
{
    echo '<li' . ($controller == 'site' && $action == 'login' ? ' class="active"' :
        '') . '><a href="' . $set['baseurl'] .
        '/site/login"><i class="fa fa-sign-in"></i> Masuk</a></li><li' . ($controller ==
        'site' && $action == 'register' ? ' class="active"' : '') . '><a href="' . $set['baseurl'] .
